...
import org.example.utility.ServiceError;
...
public class DocumentRepo {
        ...
        try {
            ...
            for (File personDirectory : listOfDirectories) {
                if (!personDirectory.isDirectory())
                    throw new ServiceException("The master directory contains a nondirectory file");
                ...
                if(documents == null){
                    ...
                    for (File document : documents) {
                        if(document.isDirectory()){
                            try {
                                walkFolder(document.getPath(), message);
                            } catch (IOException e) {
     ...
     */
    public static void walkFolder(String folderPath, StringBuilder message) throws IOException {
